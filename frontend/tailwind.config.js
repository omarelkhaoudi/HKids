  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        orange: BRAND_SECONDARY,
        accent: BRAND_SECONDARY,
        magic: BRAND_SECONDARY,
        blue: BRAND_PRIMARY,
        sky: BRAND_PRIMARY,
        cyan: BRAND_PRIMARY,
        teal: BRAND_PRIMARY,
        indigo: BRAND_PRIMARY,
        purple: BRAND_SECONDARY,
        violet: BRAND_SECONDARY,
        fuchsia: BRAND_SECONDARY,
        amber: BRAND_SECONDARY,
        yellow: BRAND_SECONDARY,
        success: {
