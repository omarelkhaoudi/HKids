...
export default function DesignSystem() {
  ...
  return (
    <div className={`min-h-screen ${theme === 'dark' ? 'dark' : ''}`}>
      <div className="bg-background text-surface-900 dark:text-surface-50 min-h-screen p-8 transition-colors duration-300">
        
        <div className="max-w-7xl mx-auto space-y-16">
          <div className="flex justify-between items-center">
            <div>
              <h1 className="text-4xl font-black mb-2">HKids Design System</h1>
              <p className="text-surface-500">Composants reutillisables v2.0</p>
            </div>
          ...
          <section>
            ...
            <div className="space-y-4 p-8 bg-white dark:bg-surface-800 rounded-3xl shadow-soft">
              ...
              <p className="text-xs text-surface-500">Caption: The quick brown fox jumps over the lazy dog.</p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="flex flex-wrap gap-4 p-8 bg-white dark:bg-surface-800 rounded-3xl shadow-soft">
          ...
          <section>
            ...
            <div className="flex items-center flex-wrap gap-6 p-8 bg-white dark:bg-surface-800 rounded-3xl shadow-soft">
          ...
          <section>
            ...
            <div className="grid md:grid-cols-2 gap-8 p-8 bg-white dark:bg-surface-800 rounded-3xl shadow-soft">
          ...
          <section>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Card className="p-6">
                ...
                <p className="text-surface-600 dark:text-surface-300">Une carte simple avec une ombre legere.</p>
              </Card>
          ...
          <section>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <EmptyState 
                ...
                onAction={() => {}}
              />
              <div className="p-8 bg-white dark:bg-surface-800 rounded-3xl shadow-soft space-y-4">
