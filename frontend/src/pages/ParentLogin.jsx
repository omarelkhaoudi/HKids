      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-gradient-to-br from-primary-50 via-primary-100/50 to-secondary-50 items-center justify-center p-12 overflow-hidden border-r border-primary-100">
        ...
        >
          ...
          <div className="relative w-full aspect-square mb-12">
            <div className="absolute inset-4 bg-white/40 backdrop-blur-3xl rounded-[3rem] border border-white shadow-[0_30px_60px_-15px_rgba(123,62,184,0.15)] overflow-hidden flex items-center justify-center p-8">
              <img 
                src="/enfant3ans.webp" 
                alt="Enfant qui lit" 
              ...
              <motion.div 
                ...
                className="absolute -top-4 -right-4 bg-white/90 backdrop-blur-md px-4 py-3 rounded-2xl shadow-xl border border-white/50 flex items-center gap-2"
              >
                <span className="text-xl">✨</span>
                <div className="text-left">
                  <div className="text-xs font-bold text-surface-500">HKids</div>
                  <div className="text-sm font-extrabold text-primary-600">Espace Parent</div>
                </div>
              </motion.div>
            </div>
          </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 lg:p-20 relative bg-white">
        ...
        <div className="w-full max-w-[420px] mx-auto">
          ...
          <div className="lg:hidden flex flex-col items-center text-center mb-10 pt-16">
            ...
            <h1 className="text-3xl font-extrabold text-surface-900 tracking-tight mb-2">Bienvenue</h1>
            <p className="text-surface-600 font-medium">Connectez-vous à votre espace parent</p>
          </div>
          ...
          <div className="hidden lg:block mb-10">
            ...
            <h1 className="text-3xl font-extrabold text-surface-900 tracking-tight mb-2">Connexion</h1>
            <p className="text-surface-600 font-medium">Renseignez vos identifiants pour continuer.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-4 bg-surface-50 border-2 border-surface-100 rounded-[1.5rem] focus:bg-white focus:border-primary-500 focus:ring-4 focus:ring-primary-500/10 transition-all font-medium text-surface-900 placeholder:text-surface-400 outline-none"
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-14 py-4 bg-surface-50 border-2 border-surface-100 rounded-[1.5rem] focus:bg-white focus:border-primary-500 focus:ring-4 focus:ring-primary-500/10 transition-all font-medium text-surface-900 placeholder:text-surface-400 outline-none"
                  placeholder="••••••••"
                  required
                />
                <button
                  ...
                  className="absolute right-4 top-1/2 -translate-y-1/2 w-8 h-8 flex items-center justify-center rounded-full hover:bg-surface-200 text-surface-400 hover:text-surface-700 transition-colors focus:outline-none focus:ring-2 focus:ring-primary-500"
            ...
            <div className="flex items-center justify-between pt-2">
              <label className="flex items-center gap-2 cursor-pointer group">
                ...
                <span className="text-sm font-semibold text-surface-600 group-hover:text-surface-900 transition-colors">Se souvenir de moi</span>
              </label>
              
              <button type="button" className="text-sm font-bold text-primary-600 hover:text-primary-700 hover:underline transition-all">
                Mot de passe oublié ?
              </button>
            </div>
          ...
          <div className="mt-10 text-center">
            <p className="text-surface-600 font-medium">
              Nouveau sur HKids ?{' '}
              <Link to="/parent/signup" className="text-primary-600 font-bold hover:text-primary-700 hover:underline inline-flex items-center gap-1 transition-colors">
