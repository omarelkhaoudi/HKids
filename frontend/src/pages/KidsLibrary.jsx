...
function KidsLibrary() {
 ...
 <Link to="/kids" className="grid h-12 w-12 place-items-center rounded-full bg-card/10 text-white transition hover:bg-card/20" title="Accueil">
 <HomeIcon className="h-6 w-6" />
 </Link>
 <Link to="/content-library" className="grid h-12 w-12 place-items-center rounded-full bg-card/10 text-white transition hover:bg-card/20" title="Contenus">
 <BookIcon className="h-6 w-6" />
 </Link>
 <Link to="/favorites" className="grid h-12 w-12 place-items-center rounded-full bg-card/10 text-white transition hover:bg-card/20" title="Favoris">
 <HeartIcon className="h-6 w-6" />
 </Link>
 <Link to="/history" className="grid h-12 w-12 place-items-center rounded-full bg-card/10 text-white transition hover:bg-card/20" title="Historique">
 <HistoryIcon className="h-6 w-6" />
 </Link>
 <button onClick={handleLogout} className="grid h-12 w-12 place-items-center rounded-full bg-card/10 text-white transition hover:bg-card/20" title="Déconnexion">
 ...
 <div className="w-24 h-24 bg-card/5 rounded-full flex items-center justify-center mb-6">
 ...
 <div className="inline-flex items-center gap-2 px-3 py-1 bg-card/20 backdrop-blur-md text-white rounded-full text-xs font-bold mb-4 uppercase tracking-wider border border-white/10">
 ...
 className="flex items-center gap-2 bg-card text-slate-900 px-6 py-3 rounded-full font-black text-lg hover:bg-slate-200 transition-all hover:scale-105"
 >
 ...
 className="flex items-center gap-2 bg-card/20 backdrop-blur-md text-white border border-white/30 px-6 py-3 rounded-full font-bold text-lg hover:bg-card/30 transition-all"
 >
 ...
 <div>
 <span className="inline-block bg-card/20 backdrop-blur text-white text-[10px] font-black uppercase tracking-wider px-2 py-0.5 rounded-full mb-1">
 {theme.cue}
 </span>
...
function BookCard({
 ...
 <div className="px-2 py-1 bg-card/20 backdrop-blur-md rounded text-[10px] font-black text-white shadow-sm border border-white/20">
 ...
 favorite ? 'bg-rose-500 text-white' : 'bg-card/20 text-white hover:bg-card/40'
}`}
 >
 ...
 className="p-2 rounded-full bg-card/20 backdrop-blur-md text-white hover:bg-card/40 shadow-lg transition-colors"
 >
 ...
 : 'bg-card/20 text-white opacity-0 scale-75 group-hover:opacity-100 group-hover:scale-100 hover:bg-card/40'
}`}
 >
