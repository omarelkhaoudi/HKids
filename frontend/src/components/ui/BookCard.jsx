...
export function BookCard({ 
  ...
  return (
    <motion.div
      ...
      className={`group relative flex flex-col w-[160px] sm:w-[180px] lg:w-[220px] rounded-3xl overflow-hidden cursor-pointer bg-surface-100 dark:bg-surface-800 shadow-soft hover:shadow-floating transition-all ${className}`}
    >
      <div className="relative aspect-[3/4] overflow-hidden rounded-t-3xl bg-surface-200 dark:bg-surface-700">
        <img
      ...
      <div className="p-4 flex flex-col grow bg-white dark:bg-surface-800">
        <h3 className="font-bold text-surface-900 dark:text-white text-base line-clamp-1 group-hover:text-primary-500 transition-colors">
          {book.title}
        </h3>
