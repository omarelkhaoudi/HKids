  ...
  return (
    <div className={`relative group ${className}`}>
      ...
      <div className="hidden md:block absolute top-1/2 -translate-y-1/2 -left-4 z-10 opacity-0 group-hover:opacity-100 transition-opacity">
        <button
          onClick={scrollLeft}
          className="p-3 rounded-full bg-white/90 dark:bg-surface-800/90 shadow-large text-surface-700 dark:text-white hover:scale-110 transition-transform backdrop-blur"
