...
function LanguageSelector() {
  ...
  return (
    <div className="flex items-center gap-0 bg-white/10 rounded-2xl px-1 py-0.5 sm:px-2 sm:py-1">
      <button
        onClick={() => changeLanguage('en')}
        className={`px-2 sm:px-3 py-1 sm:py-1.5 font-medium transition-colors text-xs sm:text-sm rounded ${
          language === 'en'
            ? 'text-primary-400 bg-white/20'
      ...
      <div className="w-px h-4 sm:h-5 bg-surface-400/50 mx-0.5 sm:mx-1"></div>
      <button
